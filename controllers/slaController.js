...
exports.listSlas = async (req, res, next) => {
    try {
        ...
        logger.error('❌ listSlas error:', err);
        next(err);
    }
};
...
exports.getSla = async (req, res, next) => {
    try {
        ...
        logger.error(`❌ getSla error [${req.params.id}]:`, err);
...
exports.patchSlaStatus = async (req, res, next) => {
    try {
        ...
        logger.error(`❌ patchSlaStatus error [${req.params.id}]:`, err);
        if (err.statusCode) res.status(err.statusCode);
        next(err);
    }
};
...
exports.calculateSla = async (req, res, next) => {
    try {
        ...
        logger.error(`❌ calculateSla error [${req.params.id}]:`, err);
        if (err.statusCode) res.status(err.statusCode);
        next(err);
    }
};
...
exports.getRules = async (req, res, next) => {
    try {
        ...
        logger.error(`❌ getRules error [sla=${req.params.id}]:`, err);
        if (err.statusCode) res.status(err.statusCode);
        next(err);
    }
};
...
exports.updateRule = async (req, res, next) => {
    try {
        ...
        logger.error(`❌ updateRule error [sla=${req.params.id}, rule=${req.params.ruleId}]:`, err);
        if (err.statusCode) res.status(err.statusCode);
        next(err);
    }
};
...
exports.deleteRule = async (req, res, next) => {
    try {
        ...
        logger.error(`❌ deleteRule error [sla=${req.params.id}, rule=${req.params.ruleId}]:`, err);
        if (err.statusCode) res.status(err.statusCode);
        next(err);
    }
};
